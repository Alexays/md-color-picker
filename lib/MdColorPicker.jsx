...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ObjectOps; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return NumberOps; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return StringOps; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return DateOps; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return BoolOps; });
...
/* harmony default export */ __webpack_exports__["g"] = (lift);
...
var _regeneratorRuntime = __webpack_require__(18);
...
var _paint = __webpack_require__(20);

var _paint2 = _interopRequireDefault(_paint);

var _spaceLift = __webpack_require__(21);
...
var MdColorPicker = exports.MdColorPicker = _flowRuntime2.default.annotate(function MdColorPicker(config) {
    ...
    (0, _index.Grid)(container, materialNoAccent, ee);
...
var Grid = exports.Grid = _flowRuntime2.default.annotate(function Grid(element, colors, ee) {
    ...
    colors.forEach(function (line) {
        return (0, _index.Line)(grid, line, ee);
    });
...
var Line = exports.Line = function Line(element, colors, ee) {
  ...
  colors.forEach(function (color) {
    return (0, _index.Square)(line, color, ee);
  });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ArrayOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ObjectOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "BoolOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "NumberOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "StringOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DateOps", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "getValue", function() { return __WEBPACK_IMPORTED_MODULE_0__lift__["h"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_immupdate__ = __webpack_require__(22);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "update", function() { return __WEBPACK_IMPORTED_MODULE_1_immupdate__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "deepUpdate", function() { return __WEBPACK_IMPORTED_MODULE_1_immupdate__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DELETE", function() { return __WEBPACK_IMPORTED_MODULE_1_immupdate__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__option__ = __webpack_require__(23);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Option", function() { return __WEBPACK_IMPORTED_MODULE_2__option__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "None", function() { return __WEBPACK_IMPORTED_MODULE_2__option__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Some", function() { return __WEBPACK_IMPORTED_MODULE_2__option__["c"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__result__ = __webpack_require__(24);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Result", function() { return __WEBPACK_IMPORTED_MODULE_3__result__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Ok", function() { return __WEBPACK_IMPORTED_MODULE_3__result__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Err", function() { return __WEBPACK_IMPORTED_MODULE_3__result__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__array_range__ = __webpack_require__(25);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "range", function() { return __WEBPACK_IMPORTED_MODULE_4__array_range__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__array_fromArrayLike__ = __webpack_require__(26);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "fromArrayLike", function() { return __WEBPACK_IMPORTED_MODULE_5__array_fromArrayLike__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__object_set__ = __webpack_require__(27);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Set", function() { return __WEBPACK_IMPORTED_MODULE_6__object_set__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__function_memoize__ = __webpack_require__(28);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "memoize", function() { return __WEBPACK_IMPORTED_MODULE_7__function_memoize__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__object_is__ = __webpack_require__(7);

/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__lift__["g" /* default */]);
...
/* harmony export (immutable) */ __webpack_exports__["b"] = deepUpdate;
//--------------------------------------
//  Shallow update
//--------------------------------------
...
function makeNone() {
    ...
    self.toArray = function () { return Object(__WEBPACK_IMPORTED_MODULE_0__lift__["g" /* default */])([]); };
...
_Some.prototype = {
    ...
    map: function (fn) {
        return Option(Object(__WEBPACK_IMPORTED_MODULE_0__lift__["h" /* getValue */])(fn(this.value)));
    },
    flatMap: function (fn) {
    ...
    toArray: function () {
        return Object(__WEBPACK_IMPORTED_MODULE_0__lift__["g" /* default */])([this.value]);
    },
    toString: function () {
...
_Ok.prototype = {
    ...
    map: function (fn) {
        return Ok(Object(__WEBPACK_IMPORTED_MODULE_0__lift__["h" /* getValue */])(fn(this._value)));
    },
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = fromArrayLike;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lift__ = __webpack_require__(0);
...
function Set() {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0__lift__["e" /* ObjectOps */](result);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__object_is__ = __webpack_require__(7);
...
// module
exports.push([module.i, ".grid-wrapper{position:absolute;flex-direction:column;z-index:100;background-color:#fff}.grid,.grid-wrapper{display:inline-flex}.line{-webkit-animation:fadeIn 2s ease forwards;animation:fadeIn 2s ease forwards}@-webkit-keyframes fadeIn{to{opacity:1}}@keyframes fadeIn{to{opacity:1}}.grow{transition:all .2s ease-in-out}.grow:hover{transform:scale(1.8)}.square{width:20px;height:20px;cursor:pointer}.mdc-elevation--z0{box-shadow:0 0 0 0 rgba(0,0,0,.2),0 0 0 0 rgba(0,0,0,.14),0 0 0 0 rgba(0,0,0,.12)}.mdc-elevation--z1{box-shadow:0 2px 1px -1px rgba(0,0,0,.2),0 1px 1px 0 rgba(0,0,0,.14),0 1px 3px 0 rgba(0,0,0,.12)}.mdc-elevation--z2{box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12)}.mdc-elevation--z3{box-shadow:0 3px 3px -2px rgba(0,0,0,.2),0 3px 4px 0 rgba(0,0,0,.14),0 1px 8px 0 rgba(0,0,0,.12)}.mdc-elevation--z4{box-shadow:0 2px 4px -1px rgba(0,0,0,.2),0 4px 5px 0 rgba(0,0,0,.14),0 1px 10px 0 rgba(0,0,0,.12)}.mdc-elevation--z5{box-shadow:0 3px 5px -1px rgba(0,0,0,.2),0 5px 8px 0 rgba(0,0,0,.14),0 1px 14px 0 rgba(0,0,0,.12)}.mdc-elevation--z6{box-shadow:0 3px 5px -1px rgba(0,0,0,.2),0 6px 10px 0 rgba(0,0,0,.14),0 1px 18px 0 rgba(0,0,0,.12)}.mdc-elevation--z7{box-shadow:0 4px 5px -2px rgba(0,0,0,.2),0 7px 10px 1px rgba(0,0,0,.14),0 2px 16px 1px rgba(0,0,0,.12)}.mdc-elevation--z8{box-shadow:0 5px 5px -3px rgba(0,0,0,.2),0 8px 10px 1px rgba(0,0,0,.14),0 3px 14px 2px rgba(0,0,0,.12)}.mdc-elevation--z9{box-shadow:0 5px 6px -3px rgba(0,0,0,.2),0 9px 12px 1px rgba(0,0,0,.14),0 3px 16px 2px rgba(0,0,0,.12)}.mdc-elevation--z10{box-shadow:0 6px 6px -3px rgba(0,0,0,.2),0 10px 14px 1px rgba(0,0,0,.14),0 4px 18px 3px rgba(0,0,0,.12)}.mdc-elevation--z11{box-shadow:0 6px 7px -4px rgba(0,0,0,.2),0 11px 15px 1px rgba(0,0,0,.14),0 4px 20px 3px rgba(0,0,0,.12)}.mdc-elevation--z12{box-shadow:0 7px 8px -4px rgba(0,0,0,.2),0 12px 17px 2px rgba(0,0,0,.14),0 5px 22px 4px rgba(0,0,0,.12)}.mdc-elevation--z13{box-shadow:0 7px 8px -4px rgba(0,0,0,.2),0 13px 19px 2px rgba(0,0,0,.14),0 5px 24px 4px rgba(0,0,0,.12)}.mdc-elevation--z14{box-shadow:0 7px 9px -4px rgba(0,0,0,.2),0 14px 21px 2px rgba(0,0,0,.14),0 5px 26px 4px rgba(0,0,0,.12)}.mdc-elevation--z15{box-shadow:0 8px 9px -5px rgba(0,0,0,.2),0 15px 22px 2px rgba(0,0,0,.14),0 6px 28px 5px rgba(0,0,0,.12)}.mdc-elevation--z16{box-shadow:0 8px 10px -5px rgba(0,0,0,.2),0 16px 24px 2px rgba(0,0,0,.14),0 6px 30px 5px rgba(0,0,0,.12)}.mdc-elevation--z17{box-shadow:0 8px 11px -5px rgba(0,0,0,.2),0 17px 26px 2px rgba(0,0,0,.14),0 6px 32px 5px rgba(0,0,0,.12)}.mdc-elevation--z18{box-shadow:0 9px 11px -5px rgba(0,0,0,.2),0 18px 28px 2px rgba(0,0,0,.14),0 7px 34px 6px rgba(0,0,0,.12)}.mdc-elevation--z19{box-shadow:0 9px 12px -6px rgba(0,0,0,.2),0 19px 29px 2px rgba(0,0,0,.14),0 7px 36px 6px rgba(0,0,0,.12)}.mdc-elevation--z20{box-shadow:0 10px 13px -6px rgba(0,0,0,.2),0 20px 31px 3px rgba(0,0,0,.14),0 8px 38px 7px rgba(0,0,0,.12)}.mdc-elevation--z21{box-shadow:0 10px 13px -6px rgba(0,0,0,.2),0 21px 33px 3px rgba(0,0,0,.14),0 8px 40px 7px rgba(0,0,0,.12)}.mdc-elevation--z22{box-shadow:0 10px 14px -6px rgba(0,0,0,.2),0 22px 35px 3px rgba(0,0,0,.14),0 8px 42px 7px rgba(0,0,0,.12)}.mdc-elevation--z23{box-shadow:0 11px 14px -7px rgba(0,0,0,.2),0 23px 36px 3px rgba(0,0,0,.14),0 9px 44px 8px rgba(0,0,0,.12)}.mdc-elevation--z24{box-shadow:0 11px 15px -7px rgba(0,0,0,.2),0 24px 38px 3px rgba(0,0,0,.14),0 9px 46px 8px rgba(0,0,0,.12)}.mdc-elevation-transition{transition:box-shadow .28s cubic-bezier(.4,0,.2,1);will-change:box-shadow}@keyframes mdc-ripple-fg-radius-in{0%{animation-timing-function:cubic-bezier(.4,0,.2,1);transform:translate(var(--mdc-ripple-fg-translate-start,0)) scale(1)}to{transform:translate(var(--mdc-ripple-fg-translate-end,0)) scale(var(--mdc-ripple-fg-scale,1))}}@keyframes mdc-ripple-fg-opacity-in{0%{animation-timing-function:linear;opacity:0}to{opacity:1}}@keyframes mdc-ripple-fg-opacity-out{0%{animation-timing-function:linear;opacity:1}to{opacity:0}}.mdc-ripple-surface--test-edge-var-bug{--mdc-ripple-surface-test-edge-var:1px solid #000;visibility:hidden}.mdc-ripple-surface--test-edge-var-bug:before{border:var(--mdc-ripple-surface-test-edge-var)}.round-btn{width:40px;height:40px;margin:15px;cursor:pointer;padding:10px;border-radius:50%;--mdc-ripple-surface-width:0;--mdc-ripple-surface-height:0;--mdc-ripple-fg-size:0;--mdc-ripple-left:0;--mdc-ripple-top:0;--mdc-ripple-fg-scale:1;--mdc-ripple-fg-translate-end:0;--mdc-ripple-fg-translate-start:0;will-change:transform,opacity;-webkit-tap-highlight-color:transparent;overflow:hidden}.round-btn:not(.mdc-ripple-upgraded):active:after,.round-btn:not(.mdc-ripple-upgraded):focus:before,.round-btn:not(.mdc-ripple-upgraded):hover:before{transition-duration:85ms;opacity:.6}.round-btn:before{background-color:rgba(0,0,0,.06);position:absolute;top:-50%;left:-50%;width:200%;height:200%;transition:opacity .25s linear;border-radius:50%;opacity:0;pointer-events:none;content:\"\"}.round-btn.mdc-ripple-upgraded:before{top:-50%;left:-50%;width:200%;height:200%;transform:scale(0);transform:scale(var(--mdc-ripple-fg-scale,0))}.round-btn.mdc-ripple-upgraded--background-focused:before{opacity:.99999}.round-btn.mdc-ripple-upgraded--background-active-fill:before{transition-duration:.12s;opacity:1}.round-btn.mdc-ripple-upgraded--unbounded:before{top:0%;top:var(--mdc-ripple-top,0%);left:0%;left:var(--mdc-ripple-left,0%);width:100%;width:var(--mdc-ripple-fg-size,100%);height:100%;height:var(--mdc-ripple-fg-size,100%);transform:scale(0);transform:scale(var(--mdc-ripple-fg-scale,0))}.round-btn:after{background-color:rgba(0,0,0,.06);position:absolute;top:-50%;left:-50%;width:200%;height:200%;transition:opacity .25s linear;border-radius:50%;opacity:0;pointer-events:none;content:\"\"}.round-btn.mdc-ripple-upgraded:after{top:0;left:0;width:100%;width:var(--mdc-ripple-fg-size,100%);height:100%;height:var(--mdc-ripple-fg-size,100%);transform:scale(0);transform-origin:center center;opacity:0}.round-btn:not(.mdc-ripple-upgraded--unbounded):after{transform-origin:center center}.round-btn.mdc-ripple-upgraded--unbounded:after{top:0;top:var(--mdc-ripple-top,0);left:0;left:var(--mdc-ripple-left,0);width:100%;width:var(--mdc-ripple-fg-size,100%);height:100%;height:var(--mdc-ripple-fg-size,100%);transform:scale(0);transform-origin:center center}.round-btn.mdc-ripple-upgraded--foreground-activation:after{animation:.3s mdc-ripple-fg-radius-in forwards,83ms mdc-ripple-fg-opacity-in forwards}.round-btn.mdc-ripple-upgraded--foreground-deactivation:after{animation:83ms mdc-ripple-fg-opacity-out;transform:translate(var(--mdc-ripple-fg-translate-end,0)) scale(var(--mdc-ripple-fg-scale,1))}.color-container{display:none}.color-container-open{display:block}", ""]);
